...
SECRET_KEY = "django-insecure-jwrc63n*z$_o2(a#^$%63nau5y=)-=*%$y%r44*n6*w4_f5i=c"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "web.context_processors.issues_processor"
            ],
        },
    }
]
...
STATIC_ROOT = BASE_DIR / "newspaper" / 'staticfiles'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'newspaper', 'media')
